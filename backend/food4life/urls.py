...
urlpatterns = [
    ...
    path('favorites/<int:recipe_id>', views.rt_update_favourites, name='add/remove favourite recipe'),
    ...
    path('time_recipes/<int:time>/<int:count>', views.rt_time_recipes, name='recipes by time'),
